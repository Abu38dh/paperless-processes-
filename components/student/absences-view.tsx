...
import { BookOpen, CheckCircle2, XCircle, Loader2, GraduationCap, AlertCircle } from "lucide-react"
...
export default function AbsencesView({ studentUniversityId }: AbsencesViewProps) {
    ...
    return (
        <div className="p-6 space-y-6" dir="rtl">
            ...
            {isHidden ? (
                <div className="mt-8 rounded-lg border border-amber-200 bg-amber-50 p-6 shadow-sm">
                    <div className="flex flex-col items-center text-center space-y-3">
                        <div className="rounded-full bg-amber-100 p-3">
                            <AlertCircle className="w-8 h-8 text-amber-600" />
                        </div>
                        <h3 className="text-xl font-bold text-amber-800">سجل الغيابات غير متاح حالياً</h3>
                        <p className="text-amber-700 max-w-lg">
                            قامت إدارة الكلية بإخفاء عرض سجل الغيابات مؤقتاً. يرجى تقديم أي أعذار غياب لديك خلال المهلة المحددة عبر شاشة "تقديم طلب"، بغض النظر عن ظهور الغياب في النظام من عدمه.
                        </p>
                    </div>
                </div>
            ) : (
